...
type RightPaneItemProps = {
	title: string;
	icon?: React.ReactNode;
};
function RightPaneItem({ title, icon }: RightPaneItemProps) {
	return (
		<div className="flex flex-row items-center p-2 hover:bg-gray-200 cursor-pointer">
			<div className="h-6 w-6 mr-2 flex items-center justify-center">{icon ? icon : <span className="text-gray-600 text-sm">I</span>}</div>
